...
Both streaming and non-streaming paths are handled. The `OMIT_STREAM_OPTIONS` env var (truthy) drops `stream_options` from OpenAI requests — needed for some enterprise proxies.
